...
% primary 
make_n_round_turns(2.0/2,138.7/2,50, 7.13, 18, 'Copper', 'ipri');

make_n_round_turns(0.26/2,89/2,50, 0.3, 997, 'Copper', 'isec');


% topload 
topload_height = 34 + 50 + 997*0.3;
topload_thickness = 1;
topload_major = 165/2;
topload_minor = 65/2;
